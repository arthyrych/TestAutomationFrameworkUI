...
import { AutomationExerciseMobileRegistration } from "../../../test-classes"
...
automationExercise.geos.forEach(geo => {
  test.describe(() => {
    ...
    test.beforeEach(({ page }) => {
      productRegistration = new AutomationExerciseMobileRegistration(page, geo)
    })

    test(`AutomationExercise - MOBILE - Registration - ${geo.name} : ${geo.locale}`, async () => {
