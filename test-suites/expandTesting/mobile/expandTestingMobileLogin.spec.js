...
import { ExpandTestingMobileLogin } from "../../../test-classes"
...
expandTesting.geos.forEach(geo => {
  test.describe(() => {
    ...
    test.beforeEach(({ page }) => {
      productLogin = new ExpandTestingMobileLogin(page)
    })

    test(`ExpandTesting - MOBILE - Login - ${geo.name} : ${geo.locale}`, async () => {
