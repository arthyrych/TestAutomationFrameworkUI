...
if (!platformMap[platformArg]) {
  console.error('Invalid platform. Use "dc" (desktop chrome), "mc" (mobile chrome), "ds" (desktop safari), or "ms" (mobile safari).')
  process.exit(1)
}
...
(async () => {
  ...
  const configs = {
    'desktop chrome': {
      browser: chromium,
      options: {
        userAgent: 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.198 Safari/537.36',
    ...
    'mobile chrome': {
      browser: chromium,
      options: {
        userAgent: 'Mozilla/5.0 (Linux; Android 13; Pixel 7) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.198 Mobile Safari/537.36',
